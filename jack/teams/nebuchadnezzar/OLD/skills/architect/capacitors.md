...
**Use capacitors for operational settings that admins need to tune at runtime.** Use static config (see `config.md`) for bootstrap settings that require restart.
