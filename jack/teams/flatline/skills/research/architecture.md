...
- **Alternative approaches** — How else could this be solved? Not theoretically — concretely. What would the code look like with a different abstraction, a different boundary, a different composition model? What would you gain and what would you lose? Map the paths not taken so the caller can evaluate the choice.
...
Report back with the architectural assessment. What the decision commits to, what it hides, what alternatives exist, and whether you've seen this pattern succeed or fail before. The caller decides whether the architecture is sound. The research makes sure they've seen the full picture before they decide.
