...
Gracefully shut down the Nebuchadnezzar crew after a work item reaches a terminal state (PR created, PR augmented, PR merged, or PR rejected).
...
Track confirmations from all seven agents:
...
- Never skip the broadcast — all seven agents must hear the sleep order
