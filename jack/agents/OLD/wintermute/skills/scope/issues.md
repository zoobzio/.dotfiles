...
2. Work through each domain — hunt for issues that will cause problems
...
**Ambiguous scope** — The issue doesn't say what's in and what's out. Builders will guess wrong.
