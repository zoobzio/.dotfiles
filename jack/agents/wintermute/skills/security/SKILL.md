---
name: security
description: Attack surface analysis — input validation, auth, crypto, leakage, dependencies, concurrency, config. Invoked during PR review for security assessment.
...
4. **When in doubt, report it** — A finding that requires further validation is still worth reporting.
