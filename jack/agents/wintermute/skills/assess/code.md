...
1. Run `golangci-lint run ./...` and `go vet ./...`
2. Work through each domain — hunt for violations, inconsistencies, and maintenance traps
3. For each finding, ask: "What would a maintainer get wrong six months from now?"
...
The linter is the baseline. If it fails, the basics aren't handled.
...
Foundation problems in module organization:
