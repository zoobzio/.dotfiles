...
1. Run coverage analysis: `go test -coverprofile=coverage.out ./...`
2. Examine coverage report for gaps and false confidence
3. Audit test quality in covered code — are the tests real?
